                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="settings">
                                    <form class="form-horizontal" method="POST" action="{{ route('admin.alternatif.store') }}">
                                        @method('post')
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="usia_alternatif" id="inputName">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-3 col-form-label">Sertifikat</label>
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="sertifikat_alternatif" id="inputName">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-3 col-form-label">Pengalaman</label>
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="pengalaman_alternatif" id="inputName">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputName" class="col-sm-3 col-form-label">Berat Badan</label>
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" name="bb_alternatif" id="inputName">
                                            </div>
                                        </div>
                                        <div class="form-group row">
