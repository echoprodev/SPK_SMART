                        ...
                        <div class="card-body">
                            <div class="tab-content">
                                ...
                                <div class="active tab-pane" id="settings">
                                    <form class="form-horizontal" method="POST" action="{{ route('admin.sub-kriteria.store') }}">
                                        @method('post')
                                        @csrf
                                            ...
                                            <div class="col-sm-9">
                                                <select name="kategori_kriteria" id="" class="form-control">
                                                    @foreach ($kriteria as $data)
                                                        <option value="{{$data->nama_kriteria}}">{{$data->nama_kriteria}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="number" class="form-control" id="inputEmail" name="bobot_subkriteria">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="inputEmail" class="col-sm-3 col-form-label">Keterangan</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" id="inputEmail" name="keterangan">
                                            </div>
                                        </div>
                                        <div class="form-group row">
